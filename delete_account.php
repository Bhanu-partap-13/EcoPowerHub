...
<head>
    ...
    <title>Delete Account - Solar & Wind Energy Portal</title>
...
<body>
    <header>
        <nav class="navbar">
            <div class="logo">
                <img src="images/logo.png" alt="Solar & Wind Energy Logo">
                <h1>Solar & Wind Energy Portal</h1>
            ...
            <ul class="nav-links">
                ...
                <li class="nav-dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="delete_account.php" class="delete-account-link active"><i class="fas fa-user-times"></i> Delete Account</a></li>
