...
<head>
    ...
    <title>Clean Energy, Bright Future</title>
...
<body>
    ...
    <main>
        ...
        <section id="solar-section" class="section">
            <div class="section-header" data-aos="fade-up">
            ...
            <div class="energy-info-container">
                <div class="energy-info-content" data-aos="fade-right">
                ...
                <div class="energy-info-images" data-aos="fade-left">
        ...
        <section id="wind-section" class="section">
            ...
            <div class="energy-info-container reverse">
                <div class="energy-info-images" data-aos="fade-right">
                    <div class="image-slider">
                        ...
                        <img src="images/wind/wind_sunset.jpg" alt="Wind Turbines at Sunset">
                    </div>
                </div>
                <div class="energy-info-content" data-aos="fade-left">
    ...
    <footer>
        ...
        <div class="footer-bottom">
            <p>&copy; 2023 Clean Energy, Bright Future. All rights reserved.</p>
        </div>
    </footer>
